...
Данный проект направлен на разработку и проверку качества системы персонализированных рекомендаций по оптимизации качества сна на основе данных фитнес-браслета и машинного обучения. Проект включает полный цикл: от сбора и обработки данных до A/B тестирования эффективности рекомендаций.

что делалось
Сбор данных с браслета, а также когнитивных тестов с первого попавешгося приложения в плей маркете
Анализ взаимосвязи объективных метрик сна (данные браслета) и оценкой качества сна с браслета
