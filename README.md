...
ЧТО ДЕЛАЛОСЬ
Анализ взаимосвязи объективных метрик сна (данные браслета) и  оценки качества сна с браслета
...
Целевая переменная: оценка качества сна с браслета (sleep_score, 0-100)
...
Метрики: 95% доверительный интервал, p-value

КЛЮЧЕВЫЕ РЕЗУЛЬТАТЫ
Лучшая модель прогнозирования
Модель: GAM с регуляризацией (lam=10)

Качество: R² = 0.628 на тесте, MAE = 3.756
...
Пермутационные тесты вместо параметрических
...
Двойной бутстрап для A/B тестов

ABAB дизайн для n-of-1 исследований

ОГРАНИЧЕНИЯ
Малая выборка (n=52) ограничивает сложность моделей, мощность статистических тестов
Краткосрочные данные (невозможность учесть долгосрочные сезонные эффекты)
